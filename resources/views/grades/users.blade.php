...
@section('content')
    <div class="container">
        <h3>Группа: {{$name}}</h3>
    <table class="table table-striped" id="student_class_list">
        <tr>
            <th>#</th>
            <th>Ученик</th>
            <th>Логин</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="btn-group" role="group">
                        <button href="#" class="btn btn-primary btn-xs dropdown-toggle" id="dropdownUser1"
                                data-bs-toggle="dropdown" aria-expanded="false"> действия с учащимся
                        </button>
